		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('admin/edit_aspek') ?>" method="post">

                        <div class="form-group">
                          <input type="hidden" name="id" value="<?php echo $aspek_penilaian->id_aspek ?>" class="form-control" placeholder="">
                        </div>
						...
						<!-- ================= -->
							...
							<div class="form-group">
								...
								<input type="text" value="<?php echo $aspek_penilaian->kode_aspek ?>" class="form-control <?php echo form_error('kode_aspek') ? 'is-invalid':'' ?>" name="kode_aspek"
						...
						<!-- ================= -->
							...
							<div class="form-group">
								...
								<input type="text" value="<?php echo $aspek_penilaian->nama_aspek ?>" class="form-control <?php echo form_error('nama_aspek') ? 'is-invalid':'' ?>" name="nama_aspek" id="nama_aspek"
                            ...
                            <div class="form-group">
								...
								<input type="number" value="<?php echo $aspek_penilaian->bobot ?>" class="form-control <?php echo form_error('bobot') ? 'is-invalid':'' ?>" name="bobot" id="bobot"
								 aria-describedby="emailHelpId" placeholder="">
