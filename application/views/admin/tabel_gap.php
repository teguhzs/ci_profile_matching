				...
				<table class="table table-bordered table-sm table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<td scope="row">
								<?php echo $tampil_penilaian->skor ?>
							</td>
							<?php } ?>
						</tr>
						<tr>
						...
						<tr class='bg-success text-light'>
							<td>Nilai GAP</td>
							<td>
								<?php echo $x_ak->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_aj->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_bt->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_bmm->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_tp->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_kdjp->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_jl->nilai_sub_kriteria; ?>
							</td>
							<td>
								<?php echo $x_jt->nilai_sub_kriteria; ?>
							</td>
						</tr>
						<tr>
							<td>A1</td>
