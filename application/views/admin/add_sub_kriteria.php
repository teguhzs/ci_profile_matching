		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('admin/add_sub_kriteria') ?>" method="post">
						...
						<div class="form-group">
						  ...
						  <select class="form-control form-control-sm <?php echo form_error('id_aspek') ? 'is-invalid':'' ?>" name="id_aspek" id="id_aspek">
							...
							?>
							<option value="<?php echo $tampil->id_aspek ?>"><?php echo $tampil->nama_aspek ?></option>
							<?php 
								} 
							?>
						  </select>
						...
						<!-- ================= -->
							...
							<div class="form-group">
								...
								<input type="text" class="form-control <?php echo form_error('kode_sub_kriteria') ? 'is-invalid':'' ?>" name="kode_sub_kriteria"
						...
						<!-- ================= -->
							...
							<div class="form-group">
								...
								<input type="text" class="form-control <?php echo form_error('nama_sub_kriteria') ? 'is-invalid':'' ?>" name="nama_sub_kriteria" id="nama_sub_kriteria"
                            ...
                            <div class="form-group">
								...
								<input type="number" class="form-control <?php echo form_error('nilai_sub_kriteria') ? 'is-invalid':'' ?>" name="nilai_sub_kriteria" id="nilai_sub_kriteria"
								 aria-describedby="emailHelpId" placeholder="">
							...
							<div class="form-check form-check-inline">
								<label class="form-check-label">
									<input class="form-check-input <?php echo form_error('keterangan') ? 'is-invalid':'' ?>" type="radio" name="keterangan" id="keterangan" value="CF" checked> Core Factor
								</label>
							</div>
							<div class="form-check form-check-inline">
								<label class="form-check-label">
									<input class="form-check-input <?php echo form_error('keterangan') ? 'is-invalid':'' ?>" type="radio" name="keterangan" id="keterangan" value="SF"> Secondary Factor
								</label>
							</div>
